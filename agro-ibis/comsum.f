...
c
     ...
     >  addrainage_layer(npoi,nsoilay),   ! daily average drainage (mm/day)
     ...
     >  adtotnleach(npoi),                ! daily nitrogen leaching ( kg/ha/day) average
     >  adtotnleach_layer(npoi,nsoilay),  ! daily nitrogen leaching ( kg/ha/day) average for each layer
...
c
     ...
     >  amdrainage_layer(npoi,nsoilay),  ! monthly average drainage (mm/day)
     >  amtotnleach(npoi,nsoilay),       ! monthly average total nitrogen leaching for each soil layer (kg/ha/day)  !Y.Li
     ...
     >  amglail(npoi),                   ! monthly average green lai for lower canopy (m**2/m**2)
     >  amblail(npoi),                   ! monthly average brown lai for lower canopy (m**2/m**2)
     >  amsolar(npoi),                   ! monthly average incident solar radiation (W/m**2)
     >  amsolarnet(npoi),                ! monthly average net solar radiation (W/m**2)
     ...
     >  amnetrad(npoi),                  ! monthly average net radiation (W/m**2)
...
c
     ...
     >  aysolarnet(npoi),   ! annual average net solar radiation (w/m**2)
     ...
     >  aynetrad(npoi),     ! annual average net radiation (W/m**2)
     ...
     >  aynmintot(npoi),    ! annual total net nitrogen mineralization (kg-N/m**2/yr)
