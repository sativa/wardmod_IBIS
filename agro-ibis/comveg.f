...
c ---------------------------------------------------------------------
      module comveg
c     last modified by C. Kucharik 10.01.02 
c ---------------------------------------------------------------------
c
      use comgrid
      use compar
...
c variables to log phenology onset & offset
      logical
     >  onflagu(npoi),      ! .true. when onset of phenology in upper canopy occurs
     >  onflagl3(npoi),     ! .true. when onset of phenology of C3 grass in lower canopy occurs
     >  onflagl4(npoi),     ! .true. when onset of phenology of C4 grass in lower canopy occurs
     >  offflagu(npoi),     ! .true. when offset of phenology in upper canopy occurs
     >  offflagl3(npoi),    ! .true. when offset of phenology of C3 grass in lower canopy occurs
     >  offflagl4(npoi)    ! .true. when offset of phenology of C4 grass in lower canopy occurs
c
      real 
     >  a11soiltd(npoi),    ! 11-day average daily soil temperature (K)
     >  tsoiavg(npoi),      ! average of top two soil layers soil temperature (K)
     >  Tavgann(npoi),      ! annual average air temperature taken from 30 year climate mean dataset
c
     >  PPTavgann(npoi),    ! annual average precipitation taken from 30 year climate mean dataset
     >  daylength(npoi),    ! length of day (minutes)
     >  precipsum(npoi),    ! precipitation summation for lower canopy onset (cm)
     >  PPTsumcrit(npoi),   ! precipitation threshold for lower canopy onset (cm)
     >  stsumu(npoi),       ! soil temperature summation for upper canopy (deg C)
     >  stsuml(npoi),       ! soil temperature summation for lower canopy (deg C)
     >  sumcom(npoi),       ! onset threshold for upper canopy
     >  a3tdmin(npoi),      ! 3-day running average minimum air temperature (deg C)
     >  tminavgann(npoi),   ! annual average minimum air temperature (deg C)
...
c
     ...
     >  gdd8(npoi),         ! growing degree days > 8C for corn crops between April 1 - Sept 30 (WJS 4-22-10: Now use gdd10 for corn)
     >  gdd10(npoi),        ! growing degree days > 10C for soybean crops between April 1 - Sept 30  (WJS 4-22-10: Now use gdd10 for corn, too)
     ...
     >  fuelthresh,         ! amount of litter needed to be eligible for fire MM 4/15/2010
     >  moistextinct,       ! moisture of extinction, soil moisture above which no fire possible MM 4/15/2010
     >  adprobfire(npoi),   ! daily probablility of fire MM 4/15/2010     
     >  totsoi(npoi),       !total soil moisture in first layer ( wsoi + wisoi )
     >  firelength(npoi),   !yearly probability of fire MM 4/15/2010      
     >  firefrac(npoi),     !yearly fraction of grid cell burned by fire     
     ...
     >  templs(npoi),       ! cold-phenology trigger for shrubs (non-dimensional)
     >  greenfracl(npoi),
     >  greenfracl3(npoi),
     >  greenfracl4(npoi),
...
c
     ...
     >  nppdummy(npoi,npft) ! dummy NPP used in stats.f
c
c 1: lower canopy
c 2: upper canopy
c
...
c
     ...
     >  aleaf_init(npft),    ! initial value of allocation fraction to leaves
     >  aroot_init(npft),    ! initial value of allocation fraction to fine roots
     >  awood_init(npft),    ! initial value of allocation fraction to wood
     >  aleaf(npoi,npft),    ! fraction allocation to leaves (can vary in space & time - e.g., for crops)
     >  aroot(npoi,npft),    ! fraction allocation to fine roots (can vary in space & time - e.g., for crops)
     >  awood(npoi,npft)     ! fraction allocation to wood (can vary in space & time - e.g., for crops)
c
      end module comveg
