...
c 
      use comgrid
      use compar    ! npoi, npft, scpft, ecpft
c     use comage    ! npftu
      use comveg    ! woodnorm
      use comsoi    ! wpudmax
      ...
      use comcrop   ! Crop parameters
      use comnitr   ! N cycling parameters
c  
      implicit none
c
c Local variables
...
*                   module (subroutine STOMATA).
     ...
     >           aleaf_init(j), aroot_init(j), awood_init(j),
     >           dummyvar, dummyvar) 
      end do
